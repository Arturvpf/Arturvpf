...
Computer Engineering student at **CIn/UFPE** — ranked among **Latin America's top Computer Science institutions**.
...
**Teaching Assistant — CIn/UFPE** *(Sep 2025 – Present)*

Supporting two core Computer Science courses for 100+ students per semester:

- **Algorithms & Data Structures** — weekly office hours, exam grading, and study material creation
- **Programming Paradigms** (OOP with Java) — guiding students through object-oriented design and Java fundamentals
...
### Open to internship opportunities in Data Science, ML Engineering & Backend Development
